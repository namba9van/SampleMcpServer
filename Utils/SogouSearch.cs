...
/// резервными селекторами. Для сравнения можно было использовать So.com (360 Search) как
/// альтернативный источник того же семейства, если разметка Sogou изменится сильнее, чем
/// позволяют резервные селекторы. Дополнительные поисковые движки здесь не реализуются, чтобы
/// сохранить область проекта ограниченной.
/// </summary>
public static class SogouSearch
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // на результат, со ссылкой заголовка в h3 > a. Ниже — резервные варианты на случай изменений.
