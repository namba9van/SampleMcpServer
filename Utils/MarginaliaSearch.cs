...
/// Регистрация не требуется: используется документированный общедоступный ключ "public".
/// При превышении общего лимита сервис может вернуть 503. Укажите WEB_SEARCH_MARGINALIA_API_KEY для
/// использования персонального ключа с собственным лимитом запросов вместо общего.
/// </summary>
