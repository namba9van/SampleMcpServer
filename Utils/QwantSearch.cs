...
/// однако перед этим endpoint используется защита от ботов Datadome. При её срабатывании движок
/// корректно возвращает пустой результат с записью в журнал вместо ошибки. Обход защиты не выполняется.
/// </summary>
